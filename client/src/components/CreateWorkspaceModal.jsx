				...
				<form onSubmit={handleSubmit} className="p-6">
					<div className="mb-6">
						...
						<input
							...
							className="w-full bg-dark border border-gray-600 text-light rounded-lg px-4 py-3 focus:outline-none focus:border-blue focus:ring-1 focus:ring-blue transition-all"
							autoFocus
						/>
					</div>
					...
					<div className="flex justify-end gap-3">
						<button
							type="button"
							onClick={onClose}
							className="px-5 py-2.5 rounded-lg text-gray-300 hover:text-light hover:bg-gray-800 transition-colors font-medium"
							disabled={isLoading}
						>
							Cancel
						</button>
						<button
							...
							className={`px-6 py-2.5 rounded-lg font-bold text-light flex items-center gap-2 transition-all ${
